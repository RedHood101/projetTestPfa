...
<div class="sidenav" >
    ...
    <ul >
        ...
        <li><a href="/sales_prediction"><i class="fa fa-math fa-fw" aria-hidden="true"></i>&nbsp;Sales Predictions</a></li>
        <li><a href="/admin/manage_sales"><i class="fa fa-edit fa-fw" aria-hidden="true"></i>&nbsp;Sales By region</a></li>
        <li><a href="/admin/visualSales"><i class="fa fa-edit fa-fw" aria-hidden="true"></i>&nbsp;visual sales</a></li>
