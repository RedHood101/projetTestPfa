...
@section('content')
    ...
    <div class="dashboard" style="padding-top: 0.2rem ; display: table" >
        ...
        <div class="row expanded" style="width: 50%; height: 100%; float:left;display: table-cell">
            ...
            <div class="small-12 medium-11 column " style="background-color: white;width: 100%; height: 50%;display: table-cell;float: bottom">
